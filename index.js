...
app.post('/openapi/v1.0/*', (req, res) => {

  let endpoint = req.url.replace('/openapi/v1.0/','');
  if(endpoint == 'access-token/b2b'){
    ...
    //SEND
    axios.post('http://192.168.193.218:8066/openapi/v1.0/'+endpoint, data, headers)
...
//TEST
app.post('/test/openapi/v1.0/*', (req, res) => {
  let endpoint = req.url.replace('/test/openapi/v1.0/','');
  if(endpoint == 'access-token/b2b'){
    let privateKey = "";
    let genAuth = new signatureUtil();
    let signaturOauth = genAuth.generateOauthSignature(privateKey, req.headers["x-client-key"], req.headers["x-timestamp"]);
